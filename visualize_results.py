...
def render_flex_granular_sweep():
    ...
    file_name = "data/trajs/granular_ghost_bar.pkl"
    # file_name = "data/trajs/granular_rot_base_multi_goals.pkl"

    render_policy("FlexGranularSweep-v5",stoch=False,record=True,random_policy=False,save_path=True,policy_func=flex_fc_policy_fn,save_filename=file_name)
