...
def render_flex_granular_sweep():
    ...
    render_policy("FlexGranularSweep-v1",stoch=False,record=False,random_policy=True,save_path=True,policy_func=cnn_granular_sweep_explicit_target_policy_fn,save_filename="data/trajs/granular_voxel_bar.pkl")
