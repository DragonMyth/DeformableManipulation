...
def render_flex_granular_sweep():
    ...
    render_policy("FlexGranularSweep-v1",stoch=False,record=True,random_policy=False,save_path=True,policy_func=cnn_granular_sweep_voxel_bar_policy_fn,save_filename=file_name)
...
def render_flex_granular_torque_sweep():
    ...
    render_policy("FlexGranularSweep-v2",stoch=False,record=True,random_policy=False,save_path=True,policy_func=cnn_granular_sweep_voxel_bar_policy_fn,save_filename=file_name)
