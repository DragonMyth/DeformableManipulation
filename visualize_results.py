...
def render_flex_granular_sweep():
    ...
    render_policy("FlexPlasticReshaping-v0",stoch=False,record=True,random_policy=False,save_path=True,policy_func=cnn_particle_sweep_multi_img_policy_fn,save_filename=file_name)
