...
def train(sess, env_id, num_timesteps, timesteps_per_actor, seed, policy_param):
    from baselines.ppo1 import pposgd_simple_flex,cnn_policy_particle_sweep, cnn_policy_particle_sweep_mult_density
    ...
    model = pposgd_simple_flex.learn(env, policy_fn,
...
def main(env_name, seed, data_saving_path, batch_size_per_process, num_iterations):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', help='environment ID', default='FlexPlasticReshaping-v6')
    ...
    main(args.env, args.seed, args.data_saving_path, int(args.batch_size_per_process),
